        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
                    ...
                    {{ Form::open(array('route' => 'bed.store' , 'method' => 'POST' , 'class' => 'body')) }}
                        <div class="row clearfix">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                    {{ Form::text('bed_name',null,array('class' => 'form-control', 'placeholder' => 'Bed Name'))}}
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                    {{ Form::select('bed_category_id', $bed_categories,'null',['class'=> 'form-control' , 'placeholder' => 'Please Select Bed Category' ]) }}
                                    </div>
